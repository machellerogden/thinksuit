...
import { sampleClipPath, nextSampleIndex, countSamples, listSamples, wakewordExists } from 'thinksuit-voice/wakewords';
...
// spoken region and write a WAV into the wakeword's sample set, reusing the same
